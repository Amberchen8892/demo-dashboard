...
const CustomerListTable = (props) => {
  ...
  const textForScoreGoal = 'Percentage is calculated by how much the client’s credit score has increased from their initial enrollment, relative to the target score needed to close on solar.';
              ...
              {paginatedCustomers.map((customer) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>
                      {timeline === 'Completed' ? <CheckCircleIcon style={{ color: '#12ae6d', fontSize: 30 }} /> : timeline}
                    </TableCell>
